...
package com.iotek.dtr.zxing.decode;
...
public class DecodeFormatManager {
	...
	static {
		...
		QR_CODE_FORMATS = EnumSet.of(BarcodeFormat.QR_CODE,BarcodeFormat.PDF_417,BarcodeFormat.RSS_14,BarcodeFormat.RSS_EXPANDED,BarcodeFormat.DATA_MATRIX);
	}
